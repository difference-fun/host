...
namespace Package\Difference\Fun\Host\Controller;
...
class Cli extends Controller {
    ...
    const INFO = [
        '{{binary()}} difference_fun/host                    | Host options',
        '{{binary()}} difference_fun/host setup              | Host setup',
        '{{binary()}} difference_fun/host name add           | /etc/hosts add',
        '{{binary()}} difference_fun/host name delete        | /etc/hosts delete',
        '{{binary()}} difference_fun/host name has           | /etc/hosts has',
    ];
